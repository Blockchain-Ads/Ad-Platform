...
export class NewCampaignComponent implements OnInit{
    ...
    ngOnInit() {
        ...
        this.walletTargeting = ['MetaMask'];
        this.baseTargeting = ['Domain', 'Geo', 'Language', 'Device', 'Browser'];
        this.web3Targeting = ['Wallet Targeting', 'Chain Targeting', 'Onchain Audiences'];
